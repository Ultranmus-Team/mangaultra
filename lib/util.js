...
// (review threads, public comments), this replaces both with a shared
// "MangaUltra Team" identity, icon included, rendered the same way any
// other user's name + avatar would be.
export const ADMIN_DISPLAY_NAME = 'MangaUltra Team';
...
// consumers already thread around), so callers can decide whether to render
// the name as a link — a real user has a profile page, the shared team
// identity doesn't.
